<ul class="main-menu__list">
    ...
    <li class="dropdown @if (request()->is([
        ...
        <ul class="shadow-box">
            ...
            <li><a href="{{ route('data-protection-privacy') }}">{{ __('messages.backup_recovery') }}</a></li>
            {{-- <li><a href="{{ route('backup-recovery') }}">Backup & Recovery</a></li> --}}
            <li><a href="{{ route('advanced-technology') }}">{{ __('messages.advanced_tech') }}</a></li>
            <li><a href="{{ route('cloud-managed-services') }}"> {{ __('messages.cloud_services') }}</a></li>
        </ul>
    </li>
