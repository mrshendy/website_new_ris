...
@section('content')
    ...
    <section class="services-four">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="services-four__left wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                            ...
                            <div class="services-four__img-2">
                                ...
                                <div class="services-four__qualified-box">
                                    <div class="services-four__qualified-icon">
                                        <img src="{{ asset('assets/images/icon/services-four-qualified-icon.png') }}"
                                            alt="">
                                    </div>
                    ...
                    <div class="contact-one__right">
                        ...
                        <ul class="contact-one__list list-unstyled">
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <h4>Contact</h4>
                                    <p><a href="https://wa.me/971586677283" class="site-footer-two__contact-phone">+971
                                            586 67 7283</a></p>
                                    <p><a href="https://wa.me/201006789994" class="site-footer-two__contact-phone">+20
                                            1006 78 9994</a></p>
                                </div>
                            </li>
                        </ul>
