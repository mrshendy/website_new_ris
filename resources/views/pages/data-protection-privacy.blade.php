...
@section('title', 'AI-Powered Solutions || techguru || IT Solutions & Technology Laravel Template')
@push('styles')
...
@section('content')
    <x-strickyHeader />
    <x-page-header title="AI-Powered Solutions" subtitle="AI-Powered Solutions" />
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-5">
                    <div class="services-details__left">
                        <div class="services-details__services-list-box">
                            <h3 class="services-details__services-list-title">{{ __('messages.ai_services.more_services') }}
                            </h3>
                        ...
                        <div class="services-details__need-help">
                            <div class="services-details__need-help-img">
                                <img src="{{ asset('assets/images/img/pexels-ron-lach-97838122.jpg') }}"
                                    alt="">
                                <div class="services-details__need-help-content">
                                    <div class="services-details__need-help-bdr"></div>
                                    <h3 class="services-details__need-help-title">
                                        {{ __('messages.ai_services.need_help') }}</h3>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="services-details__right">
                        <h3 class="services-details__title-1">{{ __('messages.ai_services.main_title') }}</h3>
                        <div class="services-details__bdr"></div>
                        {{-- <p class="services-details__text-1">{{ __('messages.ai_services.main_text_1') }}</p>
                        <p class="services-details__text-2">{{ __('messages.ai_services.main_text_2') }}</p> --}}
                        <div class="services-details__img-1">
                            <img src="{{ asset('assets/images/img/pexels-ron-lach-9783353.jpg') }}" alt="">
                        </div>
                        <h4 class="services-details__title-2">{{ __('messages.ai_services.core_features_title') }}</h4>
                        <p class="services-details__text-3">{{ __('messages.ai_services.core_features_text') }}</p>
                                ...
                                <div class="col-xl-6">
                                    <ul class="services-details__points-list list-unstyled">
                                        <li>
                                            ...
                                            <p>{{ __('messages.ai_services.feature_point_1') }}</p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                                <span class="icon-tick-inside-circle"></span>
                                            </div>
                                            <p>{{ __('messages.ai_services.feature_point_2') }}</p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                                <span class="icon-tick-inside-circle"></span>
                                            </div>
                                            <p>{{ __('messages.ai_services.feature_point_3') }}</p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xl-6">
                                    <ul
                                        ...
                                        <li>
                                            ...
                                            <p>{{ __('messages.ai_services.feature_point_4') }}</p>
                                        </li>
                                        {{-- <li>
                                            <div class="icon">
                                                <span class="icon-tick-inside-circle"></span>
                                            </div>
                                            <p>{{ __('messages.ai_services.feature_point_5') }}</p>
                                        </li> --}}
                                        {{-- <li>
                                            <div class="icon">
                                                <span class="icon-tick-inside-circle"></span>
                                            </div>
                                            <p>{{ __('messages.ai_services.feature_point_6') }}</p>
                                        </li> --}}
                                    </ul>
                                </div>
                            </div>
                        ...
                        <h4 class="services-details__title-3">{{ __('messages.ai_services.partner_title') }}</h4>
                        <p class="services-details__text-4">{{ __('messages.ai_services.partner_text') }}</p>
                                ...
                                <div class="col-xl-6">
                                    <ul class="services-details__points-two list-unstyled">
                                        <li>
                                            ...
                                            <div class="content">
                                                <h5>{{ __('messages.ai_services.tailored_strategies_title') }}</h5>
                                                <p>{{ __('messages.ai_services.tailored_strategies_text') }}</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="content">
                                                <h5>{{ __('messages.ai_services.end_to_end_title') }}</h5>
                                                <p>{{ __('messages.ai_services.end_to_end_text') }}</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xl-6">
                                    <ul
                                        ...
                                        <li>
                                            ...
                                            <div class="content">
                                                <h5>{{ __('messages.ai_services.data_driven_title') }}</h5>
                                                <p>{{ __('messages.ai_services.data_driven_text') }}</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="content">
                                                <h5>{{ __('messages.ai_services.transparent_reporting_title') }}</h5>
                                                <p>{{ __('messages.ai_services.transparent_reporting_text') }}</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <p class="services-details__text-5">{{ __('messages.ai_services.get_started_text') }}</p>
                    </div>
                </div>
            </div>
        </div>
